...
- **`cip_knowledge_chunks` rows (Postgres canonical):** 32,088
- **Embedding model:** `qwen/qwen3-embedding-4b (primary=qwen3-embedding:4b-q8_0)` @ 2560d
- **CIP-Pinecone vectors:** 32,088  ·  parity ✓
  - `cip__dec814db-722a-4730-8e60-51afc4a5dad9__661ecab4-dddb-5924-a34d-af1c5133132d`: 32,088

| source_kind | rows |
|---|---|
| `cip_engagement_note` | 14,909 |
| `cip_ticket_comment` | 14,129 |
| `cip_engagement_meeting` | 3,050 |

### Originals (files)

- **`cip_files` rows:** 0
- **CIP-R2 (`cip-originals/dec814db-722a-4730-8e60-51afc4a5dad9/`):** 0 files / 0 B
- **Legacy R2 prefix (`dec814db-722a-4730-8e60-51afc4a5dad9/`):** 4 files / 384.8 KB _(pre-Hard-Split holdovers — see Drift section)_

### Hard Split drift

⚠ Legacy R2 prefix `dec814db-722a-4730-8e60-51afc4a5dad9/` holds **4 files** (384.8 KB) outside `cip-originals/` — kept as cold backup; migration is optional.
