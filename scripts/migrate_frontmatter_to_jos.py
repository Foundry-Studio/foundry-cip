...
DOC_MAPPING: dict[str, tuple[str, str, str, str, int, str]] = {
    ...
    "docs/CIP-CHEATSHEET.md": (
        "CIP-DIAG-103", "diagnostic", "meta", "adopt", 1,
        "Auto-generated cross-tenant CIP inventory — structured / derived / originals + drift flags. Regenerated by scripts/generate_cip_cheatsheet.py."),
