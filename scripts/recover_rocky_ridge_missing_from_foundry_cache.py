...
def main() -> int:
    print(f"RUN_BEGAN tag=recover_rocky_ridge_missing_from_foundry_cache at={datetime.now(UTC).isoformat()}")
    ...
    print(f"RUN_ENDED tag=recover_rocky_ridge_missing_from_foundry_cache at={datetime.now(UTC).isoformat()}")
